...
export default function Footer () {
  return (
    <footer className='bg-primary w-full h-[300px] md:h-[220px] overflow-hidden flex flex-col items-center text-textWhite text-small justify-between md:justify-around p-5 md:flex-row'>
